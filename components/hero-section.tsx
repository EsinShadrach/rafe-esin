...
export function HeroSection() {
  return (
    <div className="pt-[7.5rem] md:pt-40 text-zinc-900">
      <div className="relative flex w-full py-12 items-center justify-center text-center bg-[rgb(249_249_249)] min-h-[35rem]">
        ...
        <div className="flex flex-col items-center justify-center w-full h-full gap-8">
          <div className="flex items-center justify-center pr-5 mx-auto text-sm font-medium short-desc w-fit gap-2 md:text-lg">
            <div>MOBILE APP DEVELOPER</div>
            <SparkleIcon className="w-4 h-4 animate-pulse" strokeWidth={1} />
          ...
          <div className="space-y-2">
            <div className="relative max-w-5xl mx-auto text-4xl font-black uppercase md:text-7xl">
              {[
                {
            ...
            <div className="mt-10">
              <i className="text-base font-semibold md:text-2xl">— Everytime</i>
              .
            </div>
          </div>
          <div className="text-lg italic font-medium md:text-2xl text-zinc-900">
