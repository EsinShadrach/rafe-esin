...
export default function NavbarContainer({
  ...
  return (
    <div
      className={`fixed top-0 left-0 text-white w-full h-full bg-black z-[90] transition-transform duration-500 ease-in-out ${
          ...
          >
            ...
            <div
              className={`absolute inset-0 bg-white transition-transform duration-300 ease-out ${
                hoveredRoute === idx ? "scale-y-100" : "scale-y-0"
              } ${
            ...
            <div
              className={`relative z-10 transition-colors duration-300 ${
                hoveredRoute === idx ? "text-black" : "text-white"
              }`}
            >
